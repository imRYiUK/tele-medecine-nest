...
const journal_activity_service_1 = require("./journal-activity.service");
...
exports.JournalModule = JournalModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [journal_service_1.JournalService, journal_activity_service_1.JournalActivityService],
        exports: [journal_service_1.JournalService, journal_activity_service_1.JournalActivityService]
    })
], JournalModule);
