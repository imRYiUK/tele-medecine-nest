...
exports.MedicalRecordsController = exports.PatientsController = void 0;
const common_1 = require("@nestjs/common");
const patients_service_1 = require("./patients.service");
const create_patient_dto_1 = require("./dto/create-patient.dto");
const update_patient_dto_1 = require("./dto/update-patient.dto");
const find_patients_dto_1 = require("./dto/find-patients.dto");
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [find_patients_dto_1.FindPatientsDto]),
    __metadata("design:returntype", void 0)
...
let MedicalRecordsController = class MedicalRecordsController {
    ...
    create(createMedicalRecordDto, req) {
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)("ADMIN", "MEDECIN"),
    (0, swagger_1.ApiOperation)({ summary: 'Créer un nouveau dossier médical' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Dossier médical créé avec succès' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
